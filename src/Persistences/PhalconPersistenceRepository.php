...
class PhalconPersistenceRepository implements PersistenceRepositoryInterface
{
    use RepositoryTrait;
     ...
     * @var string
     */
    protected $model = 'Cartalyst\Sentinel\Persistences\PhalconPersistence';
    ...
    public function flush(PersistableInterface $persistable, $forget = true)
    {
        ...
        foreach ($persistable->persistences as $persistence) {
