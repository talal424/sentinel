...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the services names
    |
    | if you use Phalcon\Di\FactoryDefault, then they are already injected
    |
    | if you use different names for these services then change them accordingly
    |
    | Security service is used for password hashing
    |
    | Crypt service must be injected as "crypt" and an encryption key is setup
    |
    | $di->set(
    |   "crypt",
    |   function () {
    ...
    */
    ...
    'users' => [
        ...
        'model' => 'Cartalyst\Sentinel\Users\PhalconUser',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the role_users model used in Sentinel.
    |
    */

    'roleUsers' => [

        'model' => 'Cartalyst\Sentinel\Roles\PhalconRoleUsers',
    ...
    */
    ...
    'roles' => [
        ...
        'model' => 'Cartalyst\Sentinel\Roles\PhalconRole',
    ...
    */
    ...
    'persistences' => [
        ...
        'model' => 'Cartalyst\Sentinel\Persistences\PhalconPersistence',
    ...
    */
    ...
    'activations' => [
        ...
        'model' => 'Cartalyst\Sentinel\Activations\PhalconActivation',
    ...
    */
    ...
    'reminders' => [
        ...
        'model' => 'Cartalyst\Sentinel\Reminders\PhalconReminder',
